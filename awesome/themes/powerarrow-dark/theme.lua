...
-- fonts
local theme_font_type                       = "FiraCode Nerd Font Medium"
local theme_font_size                       = "11"
local hotkeys_font_type                     = "FiraCode Nerd Font Medium"
...
theme.titlebar_fg_focus                         = "#98971a" -- gruvbox yellow
...
-- Calendar (awesome-wm-widgets)
local calendar_widget_api = require('awesome-wm-widgets.calendar-widget.calendar')
local mytextclock = wibox.widget.textclock()
local calendar_widget = calendar_widget_api({
  start_sunday = true,
  radius = 10,
  placement = 'top_right'
})
...
function theme.at_screen_connect(s)
    ...
    -- Create wibar shape
    local custom_wibar_shape = function(cr, width, height)
      gears.shape.rounded_rect(cr, width, height, 15)
    end

    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", border_width = dpi(10), shape = custom_wibar_shape, screen = s, height = dpi(30), bg = theme.bg_normal, fg = theme.fg_normal })
